...
#define CSL_ERROR_CONNECT_CONFIG_STR  _("For connect method \"Config\" you have to specify "\
                                        "the game path (where autoexec.cfg is located).")
        ...
        wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER)
{
    ...
    sizer_assault_path_staticbox = new wxStaticBox(notebook_pane_games, -1, _("AssaultCube"));
    ...
    sizer_sauer_path_staticbox = new wxStaticBox(notebook_pane_games, -1, _("Sauerbraten"));
    text_ctrl_sauer_options = new wxTextCtrl(notebook_pane_games, TEXT_OPTIONS_SB, wxEmptyString);
    radio_btn_sauer_config_start = new wxRadioButton(notebook_pane_games, RADIO_CONFIG_SB, _("Config (csl-connect.cfg)"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
    radio_btn_sauer_param_start = new wxRadioButton(notebook_pane_games, RADIO_PARAM_SB, _("Parameter (-xS)"));
    text_ctrl_assault_options = new wxTextCtrl(notebook_pane_games, TEXT_OPTIONS_AC, wxEmptyString);
    radio_btn_assault_config_start = new wxRadioButton(notebook_pane_games, RADIO_CONFIG_AC, _("Config (csl-connect.cfg)"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
    radio_btn_assault_param_start = new wxRadioButton(notebook_pane_games, RADIO_PARAM_AC, _("Parameter (-xS)"));
...
void CslDlgSettings::set_properties()
{
    ...
    radio_btn_assault_param_start->Enable(false);
    ...
    if (m_settings.m_connectModeSB==CONNECT_MODE_CONFIG)
        radio_btn_sauer_config_start->SetValue(true);
    else
        radio_btn_sauer_param_start->SetValue(true);
    if (m_settings.m_connectModeAC==CONNECT_MODE_CONFIG)
        radio_btn_assault_config_start->SetValue(true);
    else
...
void CslDlgSettings::do_layout()
{
    ...
    fpickSauer=new wxFilePickerCtrl(notebook_pane_games,FILE_PICKER_SB,wxEmptyString,
    ...
    fpickAssault=new wxFilePickerCtrl(notebook_pane_games,FILE_PICKER_AC,wxEmptyString,
                                      _("Select AssaultCube executable"),ext,
                                      wxDefaultPosition,sizePicker,
                                      wxFLP_DEFAULT_STYLE|wxFLP_USE_TEXTCTRL|wxFLP_FILE_MUST_EXIST);
    dpickSauer=new wxDirPickerCtrl(notebook_pane_games,DIR_PICKER_SB,m_settings.m_configPathSB,
                                   _("Select Sauerbraten game path"),
                                   wxDefaultPosition,sizePicker,
                                   wxDIRP_DEFAULT_STYLE|wxDIRP_USE_TEXTCTRL|wxDIRP_DIR_MUST_EXIST);
    dpickAssault=new wxDirPickerCtrl(notebook_pane_games,DIR_PICKER_AC,m_settings.m_configPathAC,
    ...
    wxFlexGridSizer* grid_sizer_pane_games = new wxFlexGridSizer(2, 1, 0, 0);
    wxStaticBoxSizer* sizer_assault_path = new wxStaticBoxSizer(sizer_assault_path_staticbox, wxHORIZONTAL);
    wxFlexGridSizer* grid_sizer_assault_path = new wxFlexGridSizer(3, 2, 0, 0);
    wxFlexGridSizer* grid_sizer_assault_connect = new wxFlexGridSizer(1, 2, 0, 0);
    wxStaticBoxSizer* sizer_sauer_path = new wxStaticBoxSizer(sizer_sauer_path_staticbox, wxVERTICAL);
    wxFlexGridSizer* grid_sizer_sauer_path = new wxFlexGridSizer(3, 2, 0, 0);
    wxFlexGridSizer* grid_sizer_sauer_connect = new wxFlexGridSizer(1, 2, 0, 0);
    wxStaticText* label_sauer_exe = new wxStaticText(notebook_pane_games, wxID_ANY, _("Game executable:"));
    grid_sizer_sauer_path->Add(label_sauer_exe, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
    wxStaticText* label_sauer_path = new wxStaticText(notebook_pane_games, wxID_ANY, _("Game directory:"));
    grid_sizer_sauer_path->Add(label_sauer_path, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
    wxStaticText* label_sauer_options = new wxStaticText(notebook_pane_games, wxID_ANY, _("Game paramters:"));
    grid_sizer_sauer_path->Add(label_sauer_options, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
    grid_sizer_sauer_path->Add(text_ctrl_sauer_options, 0, wxALL|wxEXPAND, 4);
    wxStaticText* label_sauer_connect = new wxStaticText(notebook_pane_games, wxID_ANY, _("Connect method:"));
    grid_sizer_sauer_path->Add(label_sauer_connect, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
    grid_sizer_sauer_connect->Add(radio_btn_sauer_config_start, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
    grid_sizer_sauer_connect->Add(radio_btn_sauer_param_start, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 4);
    grid_sizer_sauer_connect->AddGrowableCol(1);
    grid_sizer_sauer_path->Add(grid_sizer_sauer_connect, 1, wxEXPAND, 0);
    grid_sizer_sauer_path->AddGrowableCol(1);
    sizer_sauer_path->Add(grid_sizer_sauer_path, 1, wxEXPAND, 0);
    grid_sizer_pane_games->Add(sizer_sauer_path, 1, wxALL|wxEXPAND, 4);
    wxStaticText* label_assault_exe = new wxStaticText(notebook_pane_games, wxID_ANY, _("Game executable:"));
    grid_sizer_assault_path->Add(label_assault_exe, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
    wxStaticText* label_assault_path = new wxStaticText(notebook_pane_games, wxID_ANY, _("Game directory:"));
    grid_sizer_assault_path->Add(label_assault_path, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
    wxStaticText* label_assault_options = new wxStaticText(notebook_pane_games, wxID_ANY, _("Game paramters:"));
    grid_sizer_assault_path->Add(label_assault_options, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
    grid_sizer_assault_path->Add(text_ctrl_assault_options, 0, wxALL|wxEXPAND, 4);
    wxStaticText* label_assault_connect = new wxStaticText(notebook_pane_games, wxID_ANY, _("Connect method:"));
    grid_sizer_assault_path->Add(label_assault_connect, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
    grid_sizer_assault_connect->Add(radio_btn_assault_config_start, 0, wxALL|wxALIGN_CENTER_VERTICAL, 4);
    grid_sizer_assault_connect->Add(radio_btn_assault_param_start, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 4);
    ...
    sizer_assault_path->Add(grid_sizer_assault_path, 1, wxEXPAND, 0);
    grid_sizer_pane_games->Add(sizer_assault_path, 1, wxALL|wxEXPAND, 4);
    notebook_pane_games->SetSizer(grid_sizer_pane_games);
    grid_sizer_pane_games->AddGrowableCol(0);
    ...
    wxSize b=notebook_pane_games->GetBestSize();
    wxSize c=grid_sizer_button->GetMinSize();
    wxSize d(a.x,b.y+c.y);
