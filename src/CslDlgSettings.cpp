...
void CslDlgSettings::do_layout()
{
    ...
    grid_sizer_spin_ctrl_update->Add(spin_ctrl_update, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 4);
    grid_sizer_spin_ctrl_update->Add(1, 1, 0, 0, 0);
    ...
    grid_sizer_spin_ctrl_server_cleanup->Add(spin_ctrl_server_cleanup, 0, wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 4);
    grid_sizer_spin_ctrl_server_cleanup->Add(1, 1, 0, 0, 0);
