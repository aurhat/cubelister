        ...
        wxDialog(parent, id, title, pos, size, style)
{
    ...
    notebook_settings = new wxNotebook(this, wxID_ANY);
    notebook_pane_other = new wxPanel(notebook_settings, wxID_ANY);
    notebook_pane_colour = new wxPanel(notebook_settings, wxID_ANY);
    sizer_colours_server_staticbox = new wxStaticBox(notebook_pane_colour, wxID_ANY, _("Server"));
    sizer_colours_player_staticbox = new wxStaticBox(notebook_pane_colour, wxID_ANY, _("Player"));
    sizer_times_staticbox = new wxStaticBox(notebook_pane_other, wxID_ANY, _("Times && Intervals"));
    sizer_tts_staticbox = new wxStaticBox(notebook_pane_other, wxID_ANY, _("Text to speech"));
    sizer_ping_staticbox = new wxStaticBox(notebook_pane_other, wxID_ANY, _("Ping thresholds"));
    sizer_systray_staticbox = new wxStaticBox(notebook_pane_other, wxID_ANY, _("System tray"));
    sizer_geoip_staticbox = new wxStaticBox(notebook_pane_other, wxID_ANY, _("GeoIP"));
    sizer_update_staticbox = new wxStaticBox(notebook_pane_other, wxID_ANY, _("Checking for program updates"));
    sizer_output_staticbox = new wxStaticBox(notebook_pane_other, wxID_ANY, _("Game output"));
    notebook_pane_games = new wxPanel(notebook_settings, wxID_ANY);
    notebook_games = new wxListbook(notebook_pane_games, wxID_ANY);
    ...
    checkbox_release_check = new wxCheckBox(notebook_pane_other, CHECK_RELEASE_VERSION, _("Released stable versions"));
    checkbox_testing_check = new wxCheckBox(notebook_pane_other, CHECK_TESTING_VERSION, _("Testing development versions"));
...
void CslDlgSettings::set_properties()
{
    ...
    checkbox_release_check->SetValue(1);
    dirpicker_game_output->Enable(0);
    // end wxGlade
    ...
    checkbox_release_check->SetValue(m_settings.CheckReleaseVersion);
    checkbox_testing_check->SetValue(m_settings.CheckTestingVersion);
...
void CslDlgSettings::do_layout()
{
    ...
    wxFlexGridSizer* grid_sizer_spin_ctrl_server_cleanup = new wxFlexGridSizer(3, 1, 0, 0);
    wxFlexGridSizer* grid_sizer_spin_ctrl_update = new wxFlexGridSizer(3, 1, 0, 0);
    wxFlexGridSizer* grid_sizer_pane_colours = new wxFlexGridSizer(2, 1, 0, 0);
    sizer_colours_player_staticbox->Lower();
    ...
    sizer_colours_server_staticbox->Lower();
    ...
    grid_sizer_colours_server->Add(label_colour_server_empty, 0, wxALIGN_CENTER_VERTICAL|wxALL, 6);
    grid_sizer_colours_server->Add(button_colour_server_empty, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL|wxEXPAND, 4);
    ...
    grid_sizer_colours_server->Add(label_colour_server_mm1, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 6);
    grid_sizer_colours_server->Add(button_colour_server_mm1, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    wxStaticText* label_colour_server_offline = new wxStaticText(notebook_pane_colour, wxID_ANY, _("Offline"));
    grid_sizer_colours_server->Add(label_colour_server_offline, 0, wxALIGN_CENTER_VERTICAL|wxALL, 6);
    grid_sizer_colours_server->Add(button_colour_server_offline, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL|wxEXPAND, 4);
    grid_sizer_colours_server->Add(1, 1, 0, 0, 0);
    wxStaticText* label_colour_server_mm2 = new wxStaticText(notebook_pane_colour, wxID_ANY, _("Locked"));
    grid_sizer_colours_server->Add(label_colour_server_mm2, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 6);
    grid_sizer_colours_server->Add(button_colour_server_mm2, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    wxStaticText* label_colour_server_full = new wxStaticText(notebook_pane_colour, wxID_ANY, _("Full"));
    grid_sizer_colours_server->Add(label_colour_server_full, 0, wxALIGN_CENTER_VERTICAL|wxALL, 6);
    grid_sizer_colours_server->Add(button_colour_server_full, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL|wxEXPAND, 4);
    grid_sizer_colours_server->Add(1, 1, 0, 0, 0);
    wxStaticText* label_colour_server_mm3 = new wxStaticText(notebook_pane_colour, wxID_ANY, _("Restricted (password, banned, private)"));
    grid_sizer_colours_server->Add(label_colour_server_mm3, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 6);
    grid_sizer_colours_server->Add(button_colour_server_mm3, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    ...
    grid_sizer_colours_player->Add(label_colour_player_master, 0, wxALIGN_CENTER_VERTICAL|wxALL, 6);
    grid_sizer_colours_player->Add(button_colour_player_master, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL|wxEXPAND, 4);
    ...
    grid_sizer_colours_player->Add(label_colour_player_auth, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 6);
    grid_sizer_colours_player->Add(button_colour_player_auth, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    wxStaticText* label_colour_player_admin = new wxStaticText(notebook_pane_colour, wxID_ANY, _("Admin"));
    grid_sizer_colours_player->Add(label_colour_player_admin, 0, wxALIGN_CENTER_VERTICAL|wxALL, 6);
    grid_sizer_colours_player->Add(button_colour_player_admin, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL|wxEXPAND, 4);
    grid_sizer_colours_player->Add(1, 1, 0, 0, 0);
    wxStaticText* label_colour_player_spectator = new wxStaticText(notebook_pane_colour, wxID_ANY, _("Spectator (background)"));
    grid_sizer_colours_player->Add(label_colour_player_spectator, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 6);
    grid_sizer_colours_player->Add(button_colour_player_spectator, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    ...
    grid_sizer_times->Add(label_update_static, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_spin_ctrl_update->Add(1, 1, 0, 0, 0);
    grid_sizer_spin_ctrl_update->Add(spin_ctrl_update, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    grid_sizer_spin_ctrl_update->Add(1, 1, 0, 0, 0);
    grid_sizer_spin_ctrl_update->AddGrowableRow(0);
    grid_sizer_spin_ctrl_update->AddGrowableRow(2);
    grid_sizer_spin_ctrl_update->AddGrowableCol(0);
    grid_sizer_times->Add(grid_sizer_spin_ctrl_update, 1, wxEXPAND, 0);
    grid_sizer_times->Add(checkbox_play_update, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    wxStaticText* label_wait_static = new wxStaticText(notebook_pane_other, wxID_ANY, _("Wait on full server (seconds):"));
    grid_sizer_times->Add(label_wait_static, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_times->Add(spin_ctrl_wait, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    ...
    grid_sizer_times->Add(label_min_playtime_static, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_times->Add(spin_ctrl_min_playtime, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    grid_sizer_times->Add(1, 1, 0, 0, 0);
    wxStaticText* label_server_cleanup = new wxStaticText(notebook_pane_other, wxID_ANY, _("Cleanup dead servers (days)"));
    grid_sizer_times->Add(label_server_cleanup, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_spin_ctrl_server_cleanup->Add(1, 1, 0, 0, 0);
    grid_sizer_spin_ctrl_server_cleanup->Add(spin_ctrl_server_cleanup, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    grid_sizer_spin_ctrl_server_cleanup->Add(1, 1, 0, 0, 0);
    grid_sizer_spin_ctrl_server_cleanup->AddGrowableRow(0);
    grid_sizer_spin_ctrl_server_cleanup->AddGrowableRow(2);
    grid_sizer_spin_ctrl_server_cleanup->AddGrowableCol(0);
    grid_sizer_times->Add(grid_sizer_spin_ctrl_server_cleanup, 1, wxEXPAND, 0);
    grid_sizer_server_cleanup->Add(checkbox_server_cleanup_favourites, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    ...
    grid_sizer_times->Add(label_tooltip_delay, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_times->Add(spin_ctrl_tooltip_delay, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    ...
    grid_sizer_times->Add(label_tooltip_delay_help, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    ...
    grid_sizer_tts->Add(checkbox_tts, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_tts->Add(label_tts_volume, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 4);
    grid_sizer_spin_ctrl_tts_volume->Add(1, 1, 0, 0, 0);
    grid_sizer_spin_ctrl_tts_volume->Add(spin_ctrl_tts_volume, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    grid_sizer_spin_ctrl_tts_volume->Add(1, 1, 0, 0, 0);
    grid_sizer_spin_ctrl_tts_volume->AddGrowableRow(0);
    grid_sizer_spin_ctrl_tts_volume->AddGrowableRow(2);
    grid_sizer_spin_ctrl_tts_volume->AddGrowableCol(0);
    grid_sizer_tts->Add(grid_sizer_spin_ctrl_tts_volume, 1, wxEXPAND, 0);
    grid_sizer_tts->Add(button_test_tts, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    ...
    grid_sizer_ping->Add(label_ping_good, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_ping->Add(spin_ctrl_ping_good, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    wxStaticText* label_ping_bad = new wxStaticText(notebook_pane_other, wxID_ANY, _("Bad"));
    grid_sizer_ping->Add(label_ping_bad, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_ping->Add(spin_ctrl_ping_bad, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 4);
    sizer_ping->Add(grid_sizer_ping, 1, wxEXPAND, 0);
    grid_sizer_tts_ping_tray_geoip->Add(sizer_ping, 1, wxALL|wxEXPAND, 4);
    grid_sizer_systray->Add(checkbox_systray, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_systray->Add(checkbox_systray_close, 0, wxALIGN_RIGHT|wxALL, 4);
    sizer_systray->Add(grid_sizer_systray, 1, wxALIGN_CENTER_VERTICAL|wxEXPAND, 0);
    grid_sizer_tts_ping_tray_geoip->Add(sizer_systray, 1, wxALL|wxEXPAND, 4);
    grid_sizer_geoip->Add(radio_btn_geoip_country, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_geoip->Add(radio_btn_geoip_city, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_geoip->Add(checkbox_geoip_update, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    ...
    grid_sizer_update->Add(checkbox_release_check, 0, wxALL, 4);
    grid_sizer_update->Add(checkbox_testing_check, 0, wxALL, 4);
    grid_sizer_update->AddGrowableCol(1);
    sizer_update->Add(grid_sizer_update, 1, wxEXPAND, 0);
    grid_sizer_pane_other->Add(sizer_update, 1, wxALL|wxEXPAND, 4);
...
void CslDlgSettings::OnCommandEvent(wxCommandEvent& event)
{
    ...
    switch (event.GetId())
    {
        ...
        case wxID_OK:
        {
            ...
            m_settings.CheckReleaseVersion = checkbox_release_check->IsChecked();
            m_settings.CheckTestingVersion = checkbox_testing_check->IsChecked();
