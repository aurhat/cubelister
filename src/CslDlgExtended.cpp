        ...
        wxDialog(parent,id,title,pos,size,style)
{
    ...
    sizer_team_score_staticbox = new wxStaticBox(this, wxID_ANY, _("Team score"));
    sizer_info_staticbox = new wxStaticBox(this, wxID_ANY, _("Game information"));
    sizer_map_label_staticbox = new wxStaticBox(this, wxID_ANY, _("Map information"));
    sizer_map_staticbox = new wxStaticBox(this, wxID_ANY, _("Map"));
    list_ctrl_players = new CslListCtrlPlayerView(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_SUNKEN|wxLC_REPORT);
...
void CslDlgExtended::set_properties()
{
    ...
    list_ctrl_players->ListInit(CslListCtrlPlayerView::SIZE_FULL);
#ifdef __WXMSW__
...
void CslDlgExtended::do_layout()
{
    ...
    sizer_map_label_staticbox->Lower();
    ...
    sizer_team_score_staticbox->Lower();
    ...
    grid_sizer_info_team->Add(sizer_team_score, 1, wxBOTTOM|wxEXPAND|wxLEFT|wxRIGHT, 4);
    ...
    grid_sizer_info_team->Add(sizer_info, 1, wxBOTTOM|wxEXPAND|wxLEFT|wxRIGHT, 4);
    grid_sizer_map_label->Add(label_map, 0, wxALIGN_CENTER|wxLEFT|wxRIGHT, 4);
    grid_sizer_author->Add(label_author_prefix, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_author->Add(label_author, 0, wxALIGN_CENTER|wxALL, 4);
    ...
    grid_sizer_info_team->Add(sizer_map_label, 1, wxBOTTOM|wxEXPAND|wxLEFT|wxRIGHT, 4);
    ...
    grid_sizer_checkboix->Add(checkbox_map, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_checkboix->AddGrowableCol(0);
    grid_sizer_main->Add(grid_sizer_checkboix, 1, wxEXPAND, 0);
    grid_sizer_main->Add(static_line, 0, wxEXPAND|wxLEFT|wxRIGHT|wxTOP, 4);
    grid_sizer_main->Add(button_close, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 4);
...
void CslDlgExtended::ClearTeamScoreLabel(wxUint32 start, wxUint32 end)
{
    ...
    {
        wxStaticText *label=(wxStaticText*)m_teamLabel[i];
...
void CslDlgExtended::UpdateTeamData()
{
    ...
    if (!m_info->Players)
    {
        ...
        label_team1->SetForegroundColour(CSL_SYSCOLOUR(wxSYS_COLOUR_WINDOWTEXT));
    ...
    else if (stats.TeamMode)
    {
        loopv(stats.m_stats)
        {
            ...
            wxStaticText *label=(wxStaticText*)m_teamLabel.Item(i);

            label->SetFont(m_labelFont);
            label->SetLabel(s);
            label->SetForegroundColour(team_colours[i]);
        ...
        if ((h=m_info->GetGame().GetBestTeam(stats,m_info->Protocol))>-1 && h<lc)
        {
            ...
            wxStaticText *label=(wxStaticText*)m_teamLabel.Item(h);
...
void CslDlgExtended::DoShow(CslServerInfo *info)
{
    ...
    m_info=info;
    list_ctrl_players->SetServerInfo(info);
