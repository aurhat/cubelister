...
void CslDlgConnectWait::do_layout()
{
    ...
    grid_sizer_top->Add(label_static, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 4);
    wxStaticText* label_spin_static = new wxStaticText(this, wxID_ANY, _("Time to wait (sec):"));
    grid_sizer_spin->Add(label_spin_static, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_spin->Add(spin_ctrl_time, 0, wxALIGN_CENTER_VERTICAL|wxALL, 4);
    grid_sizer_top->Add(grid_sizer_spin, 1, wxEXPAND, 0);
    grid_sizer_top->Add(checkbox_default, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 4);
    ...
    grid_sizer_main->Add(grid_sizer_button, 1, wxALIGN_CENTER_HORIZONTAL|wxBOTTOM, 4);
